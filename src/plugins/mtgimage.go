...
//
//Sadly mtgimage.com was shutdown by Wizards of the Coast and therefore is no longer available, for reference purposes I have kept this file.
//Maybe somebody can recreate mtgimage.com on the dark web.
package plugins
